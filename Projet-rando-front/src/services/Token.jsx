...
if (getExpiryTime()) { 
// la valeur de base est un tableau dans un string, on le parse pour faire sauter le 
// string et 
...
let loggedAndAdmin = () => { 
// Check si il y a un token valide et check si le rôle est celui d'un admin, répond true 
// quand c'est vrai 
return !!(getExpiryTime() && getRoles() === 'ROLE_ADMIN'); 
} 

export default { getToken, getDecodedToken, getRoles, getEmail, loggedAndAdmin, 
getExpiryTime}